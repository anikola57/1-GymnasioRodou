...
Για την εκτύπωση της γλάστρας θα χρησιμοποιηθεί ο 3D εκτυπωτής του Εργαστηρίου Τεχνολογίας του σχολείου. Το σχέδιο της γλάστρας θα γίνει στο online ελεύθερο λογισμικό `Tinkercad`. Με την αξιοποίηση του 3D εκτυπωτή κατασκευάζεται μία ολοκληρωμένη διάταξη, με τη γλάστρα, τη δεξαμενή νερού και τα ηλεκτρονικά, προσαρμοσμένη στις απαιτήσεις του έργου. Το ενδεικτικό σχέδιο φαίνεται παρακάτω:
...
>## Ομάδα
Στο έργο συμμετέχουν μαθητές της Β’ τάξης του 1ου Γυμνασίου Ρόδου υπό την καθοδήγηση της καθηγήτριας τεχνολογίας Αγγελικής Νικολάου.
